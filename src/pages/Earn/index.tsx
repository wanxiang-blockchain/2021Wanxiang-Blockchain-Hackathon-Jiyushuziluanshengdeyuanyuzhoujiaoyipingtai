            ...
            stakingInfos?.map(stakingInfo => {
              ...
              switch(showCat) {
                case 0:
                  break;
                case 1:
                  if (stakingInfo.tokens[1].symbol != 'BC') return;
                  break;
                case 2:
                  if (stakingInfo.tokens[0].symbol != 'BC') return;
                  break;
                case 3:
                  if (stakingInfo.tokens[0].symbol == 'BC' && stakingInfo.tokens[1].symbol == 'CJAI') break;
                  if (stakingInfo.tokens[0].symbol == 'CJAI' && stakingInfo.tokens[1].symbol == 'BC') break;
